...
- **[2026-08]** **[MiniMax-H3](examples/diffusionnft_trainer/minimax_h3/README.md)** text-to-audio-video RL is now supported with DiffusionNFT (vLLM-Omni rollout + FSDP2 LoRA). An example [T2VA LoRA recipe](examples/diffusionnft_trainer/minimax_h3/README.md) is available.
